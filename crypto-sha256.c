...
int SHA256_Final(unsigned char *digest, SHA256_CTX *ctx) {
  ...
  /*
   * The final state is an array of unsigned integers's; place them as a series
...
int main(void) {
  ...
  fail_count +=
      test(2, "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq", 56, 1,
           0x248d6a61, 0x19db06c1);
  fail_count += test(test_number++,
